...
public class R2OAlphaGenerator extends AbstractAlphaGenerator {
	...
	public R2OAlphaGenerator(Map<Node, Set<AbstractConceptMapping>> mapInferredTypes,
			AbstractMappingDocument mappingDocument) {
		super(mapInferredTypes, mappingDocument);
	}
...
//					String pkColumnAlias = rm2.generateAlias();
	...
	@Override
	public ZQuery calculateAlphaTSS(Collection<Triple> triples) throws Exception {
