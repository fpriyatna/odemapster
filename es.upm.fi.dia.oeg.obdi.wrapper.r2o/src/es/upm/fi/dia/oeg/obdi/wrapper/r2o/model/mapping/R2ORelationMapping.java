...
implements R2OElement, IRelationMapping, Cloneable
{
	...
	public String generateRangeURIPKAlias() {
		...
		return this.rangeURIAlias + Constants.KEY_SUFFIX;
	}
	...
	public String generateRangeTableAlias() {
		if(this.rangeTableAlias == null || this.rangeTableAlias == "") {
			this.rangeTableAlias = Constants.RANGE_TABLE_ALIAS + this.hashCode();
		}
	...
	public String generateAlias() {
		if(this.sourceAlias == null) {
			this.sourceAlias = Constants.VIEW_ALIAS + new Random().nextInt(10000);
		}
