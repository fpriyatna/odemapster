...
public class R2OTransformationExpression extends R2OExpression {
	...
	public Collection<ZSelectItem> getInvolvedExpression() {
		...
		for(R2OArgumentRestriction argRestriction : argRestrictions) {
			...
			//RestrictionValue restrictionValue = restriction.getRestrictionValue();
			if(restriction instanceof R2OColumnRestriction) {
				...
				*/
				...
				result.addAll(restrictionTransformation.getTransformationExpression().getInvolvedExpression());
			}
		}
