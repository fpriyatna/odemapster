...
public class EncodingTest extends TestCase {
	...
	public void testEncode10() throws Exception {
		String str = "http://edu.linkeddata.es/UPM/resource/LineaInvestigaci%C3%B3n/31656_An√°lisis del Sector de las TIC\\s";
		String strEncoded = Utility.encodeURI(str);
		System.out.println("strEncoded = " + strEncoded);
	}
	...
	public void testEncode12() throws Exception {
		String str = "http://www.google.com/espa√±a spain#lang=en,es";
		String strEncoded = Utility.encodeURI(str);
		System.out.println("strEncoded = " + strEncoded);
	}
	...
	public void testEncode13() throws Exception {
		String str = "http://geo.linkeddata.es/HospitalesMadrid#Hospit√°l110051";
		String strEncoded = Utility.encodeURI(str);
		System.out.println("strEncoded = " + strEncoded);
	}
	...
	public void testEncode21() throws Exception {
		String str = "Ò— ™·¡ È…ÎÀ ÕÌœÔ ”÷Ûˆ ⁄‹˙¸ Carlos   Mol";
		String strEncoded = Utility.encodeURI(str);
		System.out.println("strEncoded = " + strEncoded);
	}	
